      ...
      return (
        <div className="space-y-6">
           ...
           <div className="relative aspect-video rounded-xl overflow-hidden bg-gray-100 shadow-md">
             <img 
               src={previewData.coverImage || "/LOGO INTER.png"} 
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className="flex-1 py-2 bg-[#E6F0FF] text-[#0066FF] rounded hover:bg-[#CCE0FF] text-xs flex items-center justify-center"
          >
            ...
            <div className="flex justify-center py-4 bg-gray-50 border-b">
              <div className="flex items-center space-x-1 md:space-x-4">
                <button 
                  ...
                  disabled={isLoading || isUploadingLesson}
                  className={`px-3 md:px-4 py-2 rounded-full flex items-center space-x-2 ${currentStep === 1 ? 'bg-[#E6F0FF] text-[#0066FF] border border-[#0066FF]' : 'text-gray-400 opacity-50 cursor-not-allowed'}`}
                >
                ...
                <button 
                  ...
                  className={`px-3 md:px-4 py-2 rounded-full flex items-center space-x-2 ${currentStep === 2 ? 'bg-[#E6F0FF] text-[#0066FF] border border-[#0066FF]' : 'text-gray-400 opacity-50 cursor-not-allowed'}`}
                >
                  <span className="w-6 h-6 rounded-full bg-current text-white flex items-center justify-center text-xs">
                    2
                  </span>
                ...
                <button 
                  ...
                  disabled={(!isEditing && !formData.title) || isLoading || isUploadingLesson}
                  className={`px-3 md:px-4 py-2 rounded-full flex items-center space-x-2 ${currentStep === 3 ? 'bg-[#E6F0FF] text-[#0066FF] border border-[#0066FF]' : 'text-gray-400 opacity-50 cursor-not-allowed'}`}
                >
                  <span className="w-6 h-6 rounded-full bg-current text-white flex items-center justify-center text-xs">
                    3
                  </span>
                ...
                <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <input 
                      ...
                      className="w-full px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black placeholder:text-gray-400 text-sm md:text-base"
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black bg-white text-sm md:text-base"
                      disabled={isLoading}
                    >
                      ...
                      <div className="bg-gray-50 p-3 md:p-4 border-b flex items-center justify-between">
                        <div className="flex items-center gap-2 md:gap-3 flex-1">
                          ...
                          <input 
                            ...
                            className="bg-transparent border-b border-dashed border-gray-400 focus:border-[#0066FF] outline-none font-semibold text-black flex-1 placeholder:text-gray-400 text-sm md:text-base"
                      ...
                      <div className="p-3 md:p-4 space-y-2 md:space-y-3">
                        {section.lessons.map((lesson) => (
                          <div key={lesson.id} className="flex items-center p-2 md:p-3 bg-gray-100 rounded border group">
                                                          <div className="w-8 h-8 md:w-10 md:h-10 bg-[#0066FF]/10 text-[#0066FF] flex items-center justify-center rounded mr-2 md:mr-3 shrink-0">
                                                    ...
                                                    {activeSectionId === section.id ? (
                                                      <div className="border-2 border-dashed border-[#0066FF] rounded-lg p-3 md:p-4 bg-[#E6F0FF]/30 mt-3">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 mb-2 md:mb-3">
                                                          <input 
                                                            ...
                                                            className="px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black placeholder:text-gray-400 text-sm"
                                                            value={tempLesson.title} 
                                                            onChange={e => setTempLesson({...tempLesson, title: e.target.value})}
                                                            disabled={isLoading}
                                                          />
                                                          <select 
                                                            className="px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black bg-white text-sm"
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="space-y-2">
                                  <input 
                                    ...
                                    className="px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black placeholder:text-gray-400 w-full text-xs md:text-sm"
                          ...
                          <button 
                            ...
                            disabled={isLoading}
                            className="w-full py-2 border border-dashed border-gray-300 text-gray-600 rounded hover:border-[#0066FF] hover:text-[#0066FF] text-xs flex items-center justify-center transition-colors font-semibold"
                          >
                ...
                <div className="max-w-2xl mx-auto space-y-4 md:space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 md:px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0066FF] outline-none text-black placeholder:text-gray-400 text-sm"
                          ...
                          return (
                            ...
                            >
                              <input
                                ...
                                className="h-4 w-4 rounded border-gray-300 text-[#0066FF] focus:ring-2 focus:ring-offset-0 focus:ring-[#0066FF]/50"
                              />
                              <div className="flex items-center gap-2">
